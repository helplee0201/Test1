...
# Streamlit 앱 설정
st.title("신한은행 테크핀 데이터 비교 (24.10~25.03_2)")
st.write("2024.10~2025.03_2 데이터를 테이블별로 탭으로 나누어 비교합니다. 기준월을 컬럼으로, 중복제거와 중복제거X 데이터를 별도 표로 표시합니다. 숫자는 천 단위 쉼표로 포맷팅해 오른쪽 정렬됩니다.")
